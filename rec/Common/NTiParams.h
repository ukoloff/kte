...
{
public:
	virtual double GetDouble(const char * Key, double Default) const = 0;
...
public:
	...
	void Clear() noexcept override { delete this; }
	double GetDouble( const char * Key, double Default) const override;
...
protected:
	TiXmlElement * GetElement(const char * Key, size_t Length) const;
};
