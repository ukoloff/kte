...
return u("",t.key,t,e)}
function c(){return a?l:(a=1,l={}.hasOwnProperty)}
var f=i(),d=s,p=c(),h=/(?:(^|#|\.)([^#\.\[\]]+))|(\[(.+?)(?:\s*=\s*("|'|)((?:\\["'\]]|.)*?)\5)?\])/g,v={}
...
return"string"==typeof e&&(t.children=f.normalizeChildren(t.children),"["!==e)?g(v[e]||y(e),t):(t.tag=e,
t)},b=i(),x=i(),k=s,E=w
...
var S,j,O=E,T={exports:{}}
function C(){if(j)return S
j=1
var e=function(t){
...
function s(e,t){return function i(s){var f
try{
if(!t||null==s||"object"!=typeof s&&"function"!=typeof s||"function"!=typeof(f=s.then))u((function(){
...
c(f.bind(s))}}catch(e){l(e)}}}function c(e){var t=0
function n(e){return function(n){t++>0||e(n)}}var r=n(l)
try{e(n(i),r)}catch(e){r(e)}}c(t)}
...
for(var r=0;r<t.length;r++)t[r].then(e,n)}))},S=e}var A,z,N,P,_=C()
function I(){if(z)return A
z=1
var e=i()
return A=function(t){var n,r=t&&t.document,o={svg:"http://www.w3.org/2000/svg",
...
null!=u&&c(e,u,o,l,i)}}function c(t,n,o,l,u){var f=n.tag
if("string"==typeof f)switch(n.state={},null!=n.attrs&&M(n.attrs,n,o),f){
...
var a=t.tag,u=t.attrs,c=u&&u.is,f=(o=i(t)||o)?c?r.createElementNS(o,a,{is:c
}):r.createElementNS(o,a):c?r.createElement(a,{is:c}):r.createElement(a)
...
if(b(e,f,l),!x(t)&&null!=t.children){var d=t.children
...
}M(t.state,t,n),null!=t.attrs&&M(t.attrs,t,n)
...
})(n,r),null!=n.instance?(c(t,n.instance,r,o,i),n.dom=n.instance.dom,
n.domSize=null!=n.dom?n.instance.domSize:0):n.domSize=0}(t,n,o,l,u)}var f={
caption:"table",thead:"table",tbody:"table",tfoot:"table",tr:"tbody",th:"tr",
td:"tr",colgroup:"table",col:"colgroup"}
function d(e,t,n,o){
var i=t.children.match(/^\s*?<(\w+)/im)||[],l=r.createElement(f[i[1]]||"div")
...
else{var l=null!=t[0]&&null!=t[0].key,a=null!=n[0]&&null!=n[0].key,u=0,f=0
if(!l)for(;f<t.length&&null==t[f];)f++
if(!a)for(;u<n.length&&null==n[u];)u++
if(l!==a)k(e,t,f,t.length),s(e,n,u,n.length,r,o,i)
else if(a){
for(var d,p,w,b,x,S=t.length-1,j=n.length-1;S>=f&&j>=u&&(w=t[S],b=n[j],
w.key===b.key);)w!==b&&h(e,w,b,r,o,i),null!=b.dom&&(o=b.dom),S--,j--
for(;S>=f&&j>=u&&(d=t[f],p=n[u],d.key===p.key);)f++,u++,d!==p&&h(e,d,p,r,y(t,f,o),i)
for(;S>=f&&j>=u&&u!==j&&d.key===b.key&&w.key===p.key;)g(e,w,x=y(t,f,o)),w!==p&&h(e,w,p,r,x,i),
++u<=--j&&g(e,d,o),
d!==b&&h(e,d,b,r,o,i),null!=b.dom&&(o=b.dom),f++,w=t[--S],b=n[j],d=t[f],p=n[u]
for(;S>=f&&j>=u&&w.key===b.key;)w!==b&&h(e,w,b,r,o,i),null!=b.dom&&(o=b.dom),j--,
w=t[--S],b=n[j]
if(u>j)k(e,t,f,S+1)
else if(f>S)s(e,n,u,j+1,r,o,i)
else{var O,T,C=o,A=j-u+1,z=new Array(A),N=0,P=0,_=2147483647,I=0
for(P=0;P<A;P++)z[P]=-1
for(P=j;P>=u;P--){null==O&&(O=v(t,f,S+1))
var L=O[(b=n[P]).key]
null!=L&&(_=L<_?L:-1,z[P-u]=L,w=t[L],t[L]=null,w!==b&&h(e,w,b,r,o,i),null!=b.dom&&(o=b.dom),
I++)}if(o=C,I!==S-f+1&&k(e,t,f,S+1),0===I)s(e,n,u,j+1,r,o,i)
else if(-1===_)for(T=function(e){var t=[0],n=0,r=0,o=0,i=m.length=e.length
...
for(;n-- >0;)t[n]=r,r=m[r]
return m.length=0,t
}(z),N=T.length-1,P=j;P>=u;P--)p=n[P],-1===z[P-u]?c(e,p,r,i,o):T[N]===P-u?N--:g(e,p,o),
null!=p.dom&&(o=n[P].dom)
else for(P=j;P>=u;P--)p=n[P],-1===z[P-u]&&c(e,p,r,i,o),null!=p.dom&&(o=n[P].dom)
}}else{var $=t.length<n.length?t.length:n.length
for(u=u<f?u:f;u<$;u++)(d=t[u])===(p=n[u])||null==d&&null==p||(null==d?c(e,p,r,i,y(t,u+1,o)):null==p?E(e,d):h(e,d,p,r,y(t,u+1,o),i))
...
if("string"==typeof s)switch(null!=r.attrs&&D(r.attrs,r,o),s){case"#":
!function(e,t){
...
if(null!=t)for(var i in t)null==(l=t[i])||null!=n&&null!=n[i]||C(e,i,l,r)
...
null!=r.instance?(null==n.instance?c(t,r.instance,o,l,i):h(t,n.instance,r.instance,o,i,l),
...
}else E(t,n),c(t,r,o,u,l)}function v(e,t,n){
...
r=o))
if(l(t,u),i){if(null!=n){var s=function(){1&i&&((i&=2)||c())}
n.then(s,s)}if(null!=r){s=function(){2&i&&((i&=1)||c())}
r.then(s,s)}}else O(t),j(e,t)
function c(){l(t,u),O(t),j(e,t)}}function S(e,t){
...
null!=r&&O(r)}}}function T(e,t,n,o,i,l){
...
if("key"!==t&&"is"!==t&&null!=n&&!A(t))if("o"===t[0]&&"n"===t[1])R(e,t,void 0)
else if("style"===t)L(e.dom,n,null)
else if(!z(e,t,r)||"className"===t||"title"===t||"value"===t&&("option"===e.tag||"select"===e.tag&&-1===e.dom.selectedIndex&&e.dom===u())||"input"===e.tag&&"type"===t){
var o=t.indexOf(":")
...
e.dom.addEventListener(t.slice(2),e.events,!1),e.events[t]=r)}function M(e,t,n){
"function"==typeof e.oninit&&a.call(e.oninit,t),
"function"==typeof e.oncreate&&n.push(a.bind(e.oncreate,t))}function D(e,t,n){
...
T.exports=window.Promise):void 0!==e?(void 0===e.Promise?e.Promise=_:e.Promise.prototype.finally||(e.Promise.prototype.finally=_.prototype.finally),
T.exports=e.Promise):T.exports=_
var $,R,M,D,q,U,F=i(),H=function(e,t,n){var r=[],o=!1,i=-1
...
}})}function B(){if(D)return M
D=1
var e=c()
return M=Object.assign||function(t,n){for(var r in n)e.call(n,r)&&(t[r]=n[r])}}
function J(){if(U)return q
U=1
var e=K(),t=B()
...
t(s,r)
var c=u.replace(/:([^\/\.-]+)(\.{3})?/g,(function(e,t,n){
return delete s[t],null==r[t]?e:n?r[t]:encodeURIComponent(String(r[t]))
})),f=c.indexOf("?"),d=c.indexOf("#"),p=d<0?c.length:d,h=f<0?p:f,v=c.slice(0,h)
o>=0&&(v+=n.slice(o,l)),f>=0&&(v+=(o<0?"?":"&")+c.slice(f,p))
var m=e(s)
return m&&(v+=(o<0&&f<0?"?":"&")+m),i>=0&&(v+=n.slice(i)),d>=0&&(v+=(i<0?"":"&")+c.slice(d)),
v},q}
var G,Q,X,V,Y,Z,W,ee,te,ne,re,oe,ie=J(),le=c(),ae=T.exports,ue=function(e,t,n){
var r=0
...
var i,a=null!=n.method?n.method.toUpperCase():"GET",u=n.body,s=(null==n.serialize||n.serialize===JSON.serialize)&&!(u instanceof e.FormData||u instanceof e.URLSearchParams),c=n.responseType||("function"==typeof n.extract?"":"json"),f=new e.XMLHttpRequest,d=!1,p=!1,h=f,v=f.abort
for(var m in f.abort=function(){d=!0,v.call(this)
},f.open(a,t,!1!==n.async,"string"==typeof n.user?n.user:void 0,"string"==typeof n.password?n.password:void 0),
s&&null!=u&&!l(n,"content-type")&&f.setRequestHeader("Content-Type","application/json; charset=utf-8"),
"function"==typeof n.deserialize||l(n,"accept")||f.setRequestHeader("Accept","application/json, text/*"),
n.withCredentials&&(f.withCredentials=n.withCredentials),
n.timeout&&(f.timeout=n.timeout),
f.responseType=c,n.headers)le.call(n.headers,m)&&f.setRequestHeader(m,n.headers[m])
f.onreadystatechange=function(e){if(!d&&4===e.target.readyState)try{
var i,l=e.target.status>=200&&e.target.status<300||304===e.target.status||/^file:\/\//i.test(t),a=e.target.response
if("json"===c){if(!e.target.responseType&&"function"!=typeof n.extract)try{
a=JSON.parse(e.target.responseText)}catch(e){a=null}
}else c&&"text"!==c||null==a&&(a=e.target.responseText)
...
0===f.status?setTimeout((function(){p||u()})):u()}}catch(e){o(e)}
},f.ontimeout=function(e){p=!0
var t=new Error("Request timed out")
t.code=e.target.status,o(t)
},"function"==typeof n.config&&(f=n.config(f,n,t)||f)!==h&&(i=f.abort,
f.abort=function(){d=!0,i.call(this)
}),null==u?f.send():"function"==typeof n.serialize?f.send(n.serialize(u)):u instanceof e.FormData||u instanceof e.URLSearchParams?f.send(u):f.send(JSON.stringify(u))
...
var s=a.split(/\]\[?|\[/),c=o
a.indexOf("[")>-1&&s.pop()
for(var f=0;f<s.length;f++){var d=s[f],p=s[f+1],h=""==p||!isNaN(parseInt(p,10))
if(""===d)null==r[a=s.slice(0,f).join()]&&(r[a]=Array.isArray(c)?c.length:0),d=r[a]++
else if("__proto__"===d)break
if(f===s.length-1)c[d]=u
else{var v=Object.getOwnPropertyDescriptor(c,d)
null!=v&&(v=v.value),null==v&&(c[d]=v=h?[]:{}),c=v}}}return o}}function ce(){
if(V)return X
V=1
var e=se()
return X=function(t){
...
{path:l,params:n<0?{}:e(t.slice(n+1,o))}}}function fe(){if(Z)return Y
Z=1
var e=ce()
return Y=function(t){
...
ee=1
var e=c(),t=new RegExp("^(?:key|oninit|oncreate|onbeforeupdate|onupdate|onbeforeremove|onremove)$")
...
ne=1
var e=i(),t=w,n=T.exports,r=J(),o=ce(),l=fe(),a=B(),u=de(),s={}
function c(e){try{return decodeURIComponent(e)}catch(t){return e}}
return te=function(i,f){
...
i.removeEventListener("popstate",T,!1),i.removeEventListener("hashchange",O,!1)
},view:function(){if(k&&s!==E){var t=[e(h,v.key,v)]
return E&&(t=E.render(t[0])),t}}},j=A.SKIP={}
function O(){b=!1
var e=i.location.hash
"#"!==A.prefix[0]&&(e=i.location.search+e,"?"!==A.prefix[0]&&"/"!==(e=i.location.pathname+e)[0]&&(e="/"+e))
var t=e.concat().replace(/(?:%[a-f89][a-f0-9])+/gim,c).slice(A.prefix.length),n=o(t)
function r(e){console.error(e),C(p,null,{replace:!0})}
...
y=null,E=i.render?i:null,2===k?f.redraw():(k=2,f.redraw.sync())}}
...
C(p,null,{replace:!0})}(0)}function T(){b||(b=!0,g(O))}function C(e,t,n){
if(e=r(e,t),x){T()
var o=n?n.state:null,l=n?n.title:null
n&&n.replace?i.history.replaceState(o,l,A.prefix+e):i.history.pushState(o,l,A.prefix+e)
}else i.location.href=A.prefix+e}function A(e,t,n){
...
"function"==typeof i.history.pushState?i.addEventListener("popstate",T,!1):"#"===A.prefix[0]&&i.addEventListener("hashchange",O,!1),
x=!0,f.mount(e,S),O()}return A.set=function(e,t,n){
null!=y&&((n=n||{}).replace=!0),y=null,C(e,t,n)},A.get=function(){return m
...
},A},te}()("undefined"!=typeof window?window:null,e),re
}(),me.render=L(),me.redraw=ve.redraw,
me.request=he.request,me.jsonp=he.jsonp,me.parseQueryString=se(),
me.buildQueryString=K(),me.parsePathname=ce(),me.buildPathname=J(),me.vnode=i(),
me.PromisePolyfill=C(),me.censor=de(),o.exports=me
var ye={},ge=[],we=[]
var be,xe,ke="body,html{height:100%;margin:0}h1{margin-block-start:0;text-align:center}form{padding:1ex}.hidden{display:none}h2{border-top:1px dashed #000}"
...
if(o){var l=ge.indexOf(i)
;-1===l&&(l=ge.push(i)-1,we[l]={}),n=we[l]&&we[l][r]?we[l][r]:we[l][r]=a()
}else n=a()
...
return i.insertAdjacentElement(l,e),e}}(ke,{}),be=o.exports,xe=t(Object.freeze({
__proto__:null,css:ke,default:ke})),ye.view=function(){
return be.fragment(be("style",xe.css))}
var Ee,Se={},je={}
function Oe(){return!1}function Te(e){console.log("GOT",e)}
Ee=o.exports,je.oncreate=function(){var e
;(e=document.body).ondragenter=Oe,e.ondragleave=Oe,
e.ondragover=Oe,e.ondrop=function(e){return Te(e.dataTransfer.files),!1}
},je.onremove=function(){var e
;(e=document.body).ondragenter=null,e.ondragleave=null,
e.ondragover=null,e.ondrop=null},je.view=function(){var e
return e=this,Ee.fragment(Ee("input.hidden",{type:"file",accept:".xml",
oncreate:function(t){(e.uploadButton=t.dom).onchange=function(){Te(this.files)}}
}),Ee("button",{type:"button",onclick:function(){e.uploadButton.click()}
},"Загрузить результат распознавания!")," ...или перетащите XML-файл в это окно...")
}
var Ce,Ae,ze,Ne,Pe,_e,Ie,Le,$e={}
Ce=o.exports,Ae=t(Object.freeze({__proto__:null,
homepage:"https://github.com/ukoloff/kte"})),$e.view=function(){
return Ce.fragment(Ce("h2","Примечания"),Ce("ul",Ce("li",Ce("a",{
href:Ae.homepage,target:"_blank"},"Исходный код"),"@GitHub")))
},ze=o.exports,Ne=je,Pe=$e,Se.view=function(){
return ze.fragment(ze("h1",document.title="Визуализация КТЭ"),ze("form",ze(Ne)),ze(Pe))
},_e=o.exports,Ie=ye,Le=Se,setTimeout((function(){
_e.mount(document.head,Ie),_e.mount(document.body,Le)}))}()
